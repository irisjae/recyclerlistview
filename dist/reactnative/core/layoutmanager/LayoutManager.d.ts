...
export declare abstract class LayoutManager {
    ...
    abstract refix(virtualRenderer: VirtualRenderer, innerScrollComponent: React.Component, indexes: Array<number | undefined>, itemCount: number, scrollOffset: number, scrollTo: (scrollOffset: number) => void, scrollHeight: number, setScrollHeight: (height: number) => void, relayout: () => void, retrigger: () => void): void;
...
export declare class WrapGridLayoutManager extends LayoutManager {
    ...
    refix(virtualRenderer: VirtualRenderer, innerScrollComponent: React.Component, indexes: Array<number | undefined>, itemCount: number, scrollOffset: number, scrollTo: (scrollOffset: number) => void, scrollHeight: number, setScrollHeight: (height: number) => void, relayout: () => void, retrigger: () => void): void;
