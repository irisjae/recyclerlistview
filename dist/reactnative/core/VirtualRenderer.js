...
var VirtualRenderer = /** @class */ (function () {
    function VirtualRenderer(renderStackChanged, scrollOnNextUpdate, fetchStableId, isRecyclingEnabled, preserveVisiblePosition, startEdgePreserved, edgeVisibleThreshold, shiftPreservedLayouts) {
        var _this = this;
        ...
        this._onItemsChanged = function (visibleIndexes, engagedIndexes) {
            if (_this._preserveVisiblePosition && _this._layoutManager) {
                _this._layoutManager.preserveIndexes(visibleIndexes, engagedIndexes);
            }
        };
    ...
    VirtualRenderer.prototype.getPreserveVisiblePosition = function () {
    ...
    VirtualRenderer.prototype.setLayoutManager = function (layoutManager) {
        ...
        if (this._preserveVisiblePosition) {
            var preservedIndex = (_b = (_a = this._params) === null || _a === void 0 ? void 0 : _a.initialRenderIndex) !== null && _b !== void 0 ? _b : 0;
    ...
    VirtualRenderer.prototype.handleDataSetChange = function (newDataProvider, scrollOffset, holdStableId) {
        var _this = this;
        var _a;
        var preservePosition = false;
        var shiftStartEdge = false;
        var shiftLayouts = false;
        var preservedIndex = -1;
        var preservedStableId = null;
        if (this._preserveVisiblePosition && this._layoutManager) {
            var startEdgeThreshold = this._layoutManager.getLayouts()[0].y + this._edgeVisibleThreshold;
        ...
        for (var i = 0; i < oldActiveStableIdsCount; i++) {
            ...
            if (stableIdItem) {
                if (!(key in activeStableIds)) {
                    ...
                    if (!shiftLayouts &&
                        !ts_object_utils_1.ObjectUtil.isNullOrUndefined(dataIndex) && dataIndex <= maxIndex &&
                        this._layoutManager) {
                ...
                if (((_a = this._renderStack[stableIdItem.key]) === null || _a === void 0 ? void 0 : _a.dataIndex) === preservedIndex) {
