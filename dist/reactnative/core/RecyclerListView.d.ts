...
export default class RecyclerListView<P extends RecyclerListViewProps, S extends RecyclerListViewState> extends ComponentCompat<P, S> {
    ...
    private _innerScrollComponent;
    private _windowCorrectionConfig;
    private _scrollOffset;
    private _scrollHeight;
    private _isUserScrolling;
    private _isMomentumScrolling;
    private _edgeVisibleThreshold;
    private _isEdgeVisible;
    private _autoLayout;
    private _pendingAutoLayout;
    private _pendingForceLayout;
    private _baseAutoLayoutId;
    private _autoLayoutId;
    private _holdTimer?;
    private _holdStableId?;
    ...
    scrollToOffset: (x: number, y: number, animate?: boolean, useWindowCorrection?: boolean, relativeIndex?: number) => void;
    ...
    private _onAutoLayout;
    private _queueLayoutRefix;
}
