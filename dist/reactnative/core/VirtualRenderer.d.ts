...
export default class VirtualRenderer {
    ...
    private _preserveVisiblePosition;
    private _startEdgePreserved;
    private _edgeVisibleThreshold;
    private _shiftPreservedLayouts;
    private _params;
    private _layoutManager;
    private _viewabilityTracker;
    private _dimensions;
    private _optimizeForAnimations;
    constructor(renderStackChanged: (renderStack: RenderStack) => void, scrollOnNextUpdate: (point: Point) => void, fetchStableId: StableIdProvider, isRecyclingEnabled: boolean, preserveVisiblePosition: boolean, startEdgePreserved: boolean, edgeVisibleThreshold: number, shiftPreservedLayouts: boolean);
    getPreserveVisiblePosition(): boolean;
    ...
    handleDataSetChange(newDataProvider: BaseDataProvider, scrollOffset: number, holdStableId: string | undefined): void;
